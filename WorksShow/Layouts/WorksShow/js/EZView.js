...
$.fn.EZView = function(){
    ...
    self.builtObjectTemplate = function(index){
        var src   = arIndex[index].href,
            isPdf = src.match('.pdf')||src.match('.doc')||src.match('.docx')||src.match('.docm')||src.match('.ppt')||src.match('.pptx')||src.match('.pptm')||src.match('.xls')||src.match('.xlsx')||src.match('.xlsm')||src.match('.one');
