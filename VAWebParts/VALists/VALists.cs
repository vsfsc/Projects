...
namespace VAWebParts.VALists
{
    ...
    public class VALists : WebPart
    {
        // 更改可视 Web 部件项目项后，Visual Studio 可能会自动更新此路径。
        private const string _ascxPath = @"~/_CONTROLTEMPLATES/15/VAWebParts/VALists/VAListsUserControl.ascx";

        protected override void CreateChildControls()
        {
            VAListsUserControl control = Page.LoadControl(_ascxPath) as VAListsUserControl;
            if (control != null)
        ...
        /// 列表标题
        /// </summary>
        private string _listTitle= "Statistics";
        [Personalizable(true)]
        [WebBrowsable(true)]
        [WebDisplayName("列表标题")]
