...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RetrievePwd.aspx.cs" Inherits="LNMCM.Layouts.LNMCM.RetrievePwd" DynamicMasterPageFile="~masterurl/default.master" %>
...
<table style=" font-size:14px; color:#494b4c" cellspacing="0"  cellpadding="3">
    <tr>
        <td  class="tdone">报名号:<span style="color:red">*</span></td>
        <td>
