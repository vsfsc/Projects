...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MyTask.ascx.cs" Inherits="MyTask.MyTask.MyTaskUserControl" %>
<style type="text/css">
...
<ul id="dock">
        ...
        <li id="links">
            <ul class="free"  style="overflow-x:hidden;overflow-y:auto;height:220px;bottom:10px;">
        ...
        <li id="files" >
            <ul class="free"  style="overflow-x:hidden;overflow-y:auto;height:300px;">
