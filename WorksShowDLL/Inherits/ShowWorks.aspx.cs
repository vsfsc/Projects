...
namespace WorksShowDll.Inherits
{
	public partial class ShowWorks : LayoutsPageBase
	{
		...
		{
			List<WorksFile> files = DemoImageFile();
		...
		private static List<WorksFile> DemoImageFile()
		{
			List<WorksFile> wfiles = new List<WorksFile>();

   //         WorksFile wfile = new WorksFile(1, 0,2, "image1", "/WorksShow/gallery/images/pic2.jpg",null,null,null,null,null);
			//wfiles.Add(wfile);

   //         wfile = new WorksFile(2, 0, 2, "image2", "640x426", "/WorksShow/gallery/images/pic1.jpg");
			//wfiles.Add(wfile);

   //         wfile = new WorksFile(3, 0, 2, "image3", 1, "768x1024", "/WorksShow/gallery/images/pic3.jpg");
			//wfiles.Add(wfile);

   //         wfile = new WorksFile(4, 0, 2, "image4", 1, "900x596", "/WorksShow/gallery/images/pic4.jpg");
			//wfiles.Add(wfile);
	    ...
	    public static string[] GetImageSize(string imagePath)
	    {
	        ...
	        using (var webClient =new WebClient())
	        {
	            ...
	            {
                    //var image = System.FromStream(stream);
