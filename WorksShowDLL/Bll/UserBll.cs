...
namespace WorksShowDll.Bll
{
    public class UserBll
    {
        ...
        /// <returns></returns>
        public static long GetUserIdByLoginName(string loginName)
        {
        ...
        /// <returns></returns>
        public static long AddFav(Favorites favorites)
        {
        ...
        /// </summary>
        /// <param name="favorites"></param>
        public static void ModifyFav(Favorites favorites)
        {
        ...
        /// <param name="userId">用户ID</param>
        /// <returns></returns>
        public static List<Favorites> GetUserFavorites(string userId)
        {
            long uid = long.Parse(userId);
        ...
        public static List<Favorites> GetWorksFavorites(long worksId, long domainId)
        {
            List<Favorites> favs = db.Favorites.Where(f => f.UserID == worksId &&f.DomainID==domainId).ToList();
            return favs;
        }
        #endregion
        /// <summary>
