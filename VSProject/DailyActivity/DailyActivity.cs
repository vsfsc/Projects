...
namespace VSProject.DailyActivity
{
    ...
    public class DailyActivity : WebPart
    {
        // Visual Studio might automatically update this path when you change the Visual Web Part project item.
        private const string _ascxPath = @"~/_CONTROLTEMPLATES/15/VSProject/DailyActivity/DailyActivityUserControl.ascx";

        protected override void CreateChildControls()
        {
            DailyActivityUserControl control = Page.LoadControl(_ascxPath) as DailyActivityUserControl;
            if (control != null)
            {
                control.webObj = this;
            }
